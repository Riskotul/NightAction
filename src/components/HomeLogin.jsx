...
import headerHomelogin from '../assets/header_homelogin.png';
...
const HomeLogin = () => {
    return (
        <div>
            ...
            <div className="bg-[#8DD67A] w-full py-12 md:py-24 px-6 md:px-12 lg:px-20 flex flex-col md:flex-row justify-between items-center gap-10">
                <div className="flex-1 justify-items-center text-center md:text-left">
                    ...
                    <button className="bg-[#FA9F42] border-none text-black py-2 px-6 md:py-3 md:px-8 cursor-pointer rounded-xl text-lg md:text-xl mt-2 md:mt-4">
                        <Link to="/popupadopsilogin" className="no-underline text-black">
                            Adopsi
                        </Link>
                    </button>
                </div>
                <img src={headerHomelogin} alt="Deskripsi gambar" className="w-full md:w-auto h-[320px] md:h-auto" style={{ maxWidth: '700px' }} />
            </div>
            ...
            <div className="bg-[#8DD67A] w-full flex flex-col md:flex-row justify-between items-end items-center gap-5  lg:px-20 mt-10 md:mt20">
